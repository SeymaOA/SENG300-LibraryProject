 ...
 */
// After changing the ID or ISBN of a stored book, call prepareSearchIndexes().
public class BookSeyma {
	 ...
	 */
	public BookSeyma(String[] fields) {
	...
	// The shared GUI can use the same getter name as Book.java.
